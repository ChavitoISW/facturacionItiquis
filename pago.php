...
<html>
        ...
        <script>
            function lolo() {
                swal({
                    ...
                    text: "Sera redirigido al sitio de pago seguro!",
                    type: "warning",
    ...
    <body>
        <!-----------------------NO TOCAR----------------------->
        <form id="formulario" name="formulario" action="https://www.fundauna.una.ac.cr/coreSSL/index_es.php" method="post">
            <input type="hidden" name="_SIGLA_" value="<?= $orden ?>" />
            <input type="hidden" name="_CODPROY_" value="010638-01" />
            <input type="hidden" name="_PROYECTO_" value="Procame" />
            <input type="hidden" name="_DESPROYECTO_" value="<?= _Evento() ?>" />
            <input type="hidden" name="_NOMBRE_" value="<?= $_POST['nombre'] ?>" />	
            <input type="hidden" name="_APELLIDOS_" value="" />
            <input type="hidden" name="_MONEDA_" value="fundauna1"/> <!-- fundauna1: colones, fundauna2: dólares -->
            <input type="hidden" name="_MONTO_" value="<?= $monto ?>" /> 
            <input type="hidden" name="_EXITO_" value="https://www.fundauna.una.ac.cr/ssl/comercios/procame_colones/comprobante.php" />
            <input type="hidden" name="_REDIRECT_" value="https://www.fundauna.una.ac.cr/ssl/comercios/procame_colones/index.php" />
        </form>
        <!-----------------------NO TOCAR----------------------->
        <div class="wrapper">
                            ...
                            <div class="box box-info"> 												
                                ...
                                <div class="box-footer">                               
                                    <div class="pull-right">
                                        <button type="button" onclick="lolo();" class="btn btn-primary"><i class="fa fa-credit-card"></i> Pagar</button>
                                    </div>
                                    <div class="pull-left">
