                    ...
                    <center>
                        <div class="row">  
                            ...
                            <div class="box box-info"> 												
                                <div class="box-header with-border"><h3 class="box-title">Reporte de Inscripciones</h3></div>
                                <div class="box-body">                                    
                                    <table style="width:100%" cellpadding="4" cellspacing ="4">
                                        ...
                                        <?php
                                            $ROW = _QUERY("SELECT trans_compra, DATE_FORMAT(fecha, '%d/%m/%Y %T') AS fecha, cedula, nombre, correo, telefono, monto, usuario FROM tabla000 WHERE estado = '1';");
                                            ...
                                            <tr onMouseOut='mOut(this)' onMouseOver='mOver(this)'>
                                                ...
                                                <td>
                                                    <ul>
                                                        <?php 
                                                            $C = _QUERY("SELECT curso, monto FROM detalle WHERE trans_compra = '{$ROW[$x]['trans_compra']}';");
                                                            for($z=0;$z<count($C);$z++){
                                                                echo "<li>{$C[$z]['curso']}</li>";
                                                            }
                                                        ?>                                                        
                                                    </ul>
                                                </td>
                                                <td>&cent;<?= _FORMATO($ROW[$x]['monto']) ?> CRC (<?= _USUARIO($ROW[$x]['usuario']) ?>)</td>				
                                            </tr>
                                        <?php } ?>
                                        <tr><td colspan="8"><hr></td></tr>
                                        <tr><td colspan="7" align="right"><b>Total:</b>&nbsp;</td><td>&cent;<?= _FORMATO($total) ?> CRC</td></tr>
                                ...
                                <div class="box-footer">                               
                                    ...
                                    <div class="pull-left">
                                        <button type="button" onclick="location.href = 'asistencia.php?export=1';" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Exportar</button>
                                    </div>									
                                </div>                                 
                            </div>						
                        </div>     
