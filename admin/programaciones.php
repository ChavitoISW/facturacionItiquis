...
$Q = _QUERY("SELECT id, nombre, estado FROM tablaprogramaciones;");
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <script>
            ...
            function url(_id) {
                window.open('programacion_detalle.php?id=' + _id, '', 'width=900,height=600,scrollbars=yes,status=no');
            }
        </script>	
    </head>	
        ...
        <div class="wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Gestionar Programaciones</li>
                </ol>
            </section> 
            <hr>			
            <br>					
                        ...
                        <div class="box box-info" style="width:50%;">
                            ...
                            <div class="box-body">
                                <div class="form-group"> 
                                    <input type="button" value="Agregar Programación" class="btn btn-primary" onClick="url('');">
                                </div>                                        
                            </div>
                        </div>
                    </div>  
            ...
            <section class="content">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Programaciones</h3>
                    </div>
                    <div class="box-body">
                            ...
                            <tbody>
                                <?php for ($x = 0; $x < count($Q); $x++) { ?>
                                    <tr class="gradeA" align="center">
                                        ...
                                        <td><?= $Q[$x]['nombre'] ?></td>
                                        <td><?= $Q[$x]['estado'] == '1' ? 'Activa' : 'Inactivo' ?></td>
                                        <td>
